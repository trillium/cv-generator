...
The `bun run pdf` command generates PDF versions of your resume and cover letter by:
...
└────────┬────────┘
         ...
         ▼
┌─────────────────┐
│ Start Next.js   │ (bun run dev on port 7542+)
└────────┬────────┘
         │
         ▼
┌─────────────────┐
...
3. **Start Server**
   ...
   - Spawn Next.js dev server with `bun run dev -p 7542`
