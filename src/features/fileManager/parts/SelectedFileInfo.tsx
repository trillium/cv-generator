...
const SelectedFileInfo: React.FC<SelectedFileInfoProps> = ({ selectedFile, files }) => {
  ...
  return (
    <div className="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
      <h2 className="text-lg font-semibold text-gray-900 dark:text-gray-100 mb-4">Selected File</h2>
      <div className="space-y-2 text-sm">
        <div>
          <span className="text-gray-600 dark:text-gray-400">Path:</span>
          <div className="font-mono text-xs text-gray-900 dark:text-gray-100">{fileInfo.path}</div>
        </div>
        <div>
