...
export const Lines = z.array(z.object({ text: z.string(), bulletPoint: z.boolean().optional() }))
...
export const Project = z.object({
  ...
  bubbles: z.array(z.string()).optional(),
  lines: z
    .array(z.union([z.object({ text: z.string() }), z.object({ text: z.array(z.string()) })]))
    .optional(),
...
export const CVData = z.object({
  ...
  openSource: z.array(WorkExperience).optional(),
