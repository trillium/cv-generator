...
export default function Navigation() {
  ...
  return (
    <>
      ...
      {hasUnsavedChanges && (
        <div className="print:hidden fixed top-0 left-0 right-0 z-50 bg-amber-50 dark:bg-amber-900 border-b border-amber-200 dark:border-amber-700">
          <div className="flex items-center justify-between px-4 py-2">
            ...
            <div className="flex items-center gap-2">
              <button
                ...
                disabled={isLoading}
                className="px-3 py-1 text-sm font-medium text-gray-700 dark:text-gray-300 bg-white dark:bg-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600 disabled:bg-gray-100 dark:disabled:bg-gray-800 border border-gray-300 dark:border-gray-600 rounded transition-colors"
              >
              ...
              <button
                ...
                disabled={isLoading}
                className="px-3 py-1 text-sm font-medium text-white bg-amber-600 hover:bg-amber-700 dark:bg-amber-700 dark:hover:bg-amber-800 disabled:bg-amber-400 dark:disabled:bg-amber-600 border border-amber-600 dark:border-amber-700 rounded transition-colors"
              >
          ...
          <div className="flex items-center gap-4 flex-wrap">
            ...
            <div className="relative">
              <button
                ...
                className="flex items-center gap-2 px-3 py-2 text-sm font-medium text-gray-700 dark:text-gray-300 bg-gray-50 dark:bg-gray-700 hover:bg-gray-100 dark:hover:bg-gray-600 rounded-md border border-gray-300 dark:border-gray-600 transition-colors"
              >
              ...
              {isOpen && (
                <div className="absolute top-full mt-1 right-0 bg-white dark:bg-gray-800 rounded-md shadow-lg border border-gray-200 dark:border-gray-700 min-w-[140px]">
                  {layouts.map((layout) => (
                    <button
                      key={layout.value}
                      onClick={() => handleLayoutChange(layout.value)}
                      className={clsx(
                        "w-full text-left px-3 py-2 text-sm hover:bg-gray-50 dark:hover:bg-gray-700 first:rounded-t-md last:rounded-b-md",
                        {
