...
describe('EmptyFieldPlaceholder', () => {
  describe('blank string replacement', () => {
    ...
    it('replaces blank string with placeholder for textarea field', () => {
      render(
        <EmptyFieldPlaceholder fieldType="textarea" isEmpty={true} yamlPath="test.path">
          <p>{''}</p>
        </EmptyFieldPlaceholder>,
      )
    ...
    it('replaces blank string with placeholder for array field', () => {
      render(
        <EmptyFieldPlaceholder fieldType="array" isEmpty={true} yamlPath="test.path">
          <div>{''}</div>
        </EmptyFieldPlaceholder>,
      )
  ...
  describe('null content replacement', () => {
    it('replaces null content with placeholder for link field', () => {
      ...
      expect(screen.getByText('Click to add profile.links.0')).toBeInTheDocument()
    })
  })
  ...
  describe('valid content preservation', () => {
    it('preserves valid string content', () => {
      render(
        <EmptyFieldPlaceholder fieldType="text" isEmpty={false} yamlPath="test.path">
  ...
  describe('fieldType variations', () => {
    ...
    it('shows array placeholder for array fieldType', () => {
      render(
        <EmptyFieldPlaceholder fieldType="array" isEmpty={true} yamlPath="test.array">
          <div>{''}</div>
        </EmptyFieldPlaceholder>,
      )

      expect(
        screen.getByText('Click to edit test.array (not visible in print view)'),
      ).toBeInTheDocument()
    })
  })
  ...
  describe('yamlPath placeholder messages', () => {
    it('shows category placeholder for technical.category', () => {
      render(
        <EmptyFieldPlaceholder fieldType="text" isEmpty={true} yamlPath="technical.category">
          <span>{''}</span>
        </EmptyFieldPlaceholder>,
      )
    ...
    it('shows skill placeholder for technical.bubbles', () => {
      render(
        <EmptyFieldPlaceholder fieldType="text" isEmpty={true} yamlPath="technical.bubbles.0">
          <span>{''}</span>
        </EmptyFieldPlaceholder>,
      )
    ...
    it('shows skills placeholder for technical.bubbles array', () => {
      render(
        <EmptyFieldPlaceholder fieldType="array" isEmpty={true} yamlPath="technical.bubbles">
          <div>{''}</div>
        </EmptyFieldPlaceholder>,
      )

      expect(screen.getByText('Click to add technical skills section')).toBeInTheDocument()
    })

    it('shows technical skills section placeholder', () => {
      render(
        <EmptyFieldPlaceholder fieldType="text" isEmpty={true} yamlPath="technical.skills">
          <span>{''}</span>
        </EmptyFieldPlaceholder>,
      )
