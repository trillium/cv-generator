    ...
    <div className="max-w-4xl mx-auto p-6 bg-red-50 border-2 border-red-300 rounded-lg">
      <div className="mb-4">
        ...
        <p className="text-red-700">
          ...
          in resume data for{" "}
          <code className="bg-red-200 px-1 rounded">{directoryPath}</code>
        </p>
      ...
      <div className="mt-6 p-4 bg-blue-50 border border-blue-200 rounded">
        ...
        <ol className="list-decimal list-inside space-y-1 text-sm text-blue-800">
          ...
          <li>
            Check the field paths and compare the actual structure to the
            expected structure
          </li>
          <li>
            For arrays: ensure the field is formatted as <code>- item</code>{" "}
            (array), not <code>&quot;0&quot;: item</code> (object)
          </li>
