import type { PdfJobState, PdfMetadata } from '@/contexts/DirectoryManager/DirectoryManagerContext'
import type {
  PdfMetadataFile,
...
export function getPdfMetadata(metadata: PdfMetadataFile | null, type: string): PdfMetadata | null {
...
export function hasPdfError(metadata: PdfMetadataFile | null, type: string): boolean {
