...
export { deriveDirectoryFromSources, extractTopLevelKey } from './pathUtils'
...
export function serializeData(data: Record<string, unknown>, filePath: string): string {
...
export async function getMinimalFileStats(filePath: string): Promise<FileMetadata> {
