...
describe('multiFileMapper', () => {
  ...
  describe('findDataFilesInDirectory', () => {
    ...
    it('should return empty array for non-existent directory', () => {
      const result = findDataFilesInDirectory(path.join(TEST_DIR, 'nonexistent'))
  ...
  describe('validateSectionSpecificFile', () => {
    ...
    it('should throw for section-specific file with multiple sections', () => {
      expect(() => {
        validateSectionSpecificFile('work.yml', ['workExperience', 'education'])
    ...
    it('should not throw for full data files', () => {
      expect(() => {
        validateSectionSpecificFile('data.yml', ['workExperience', 'education', 'info'])
      }).not.toThrow()
    })
  })
